export default function Privacy() {
  return (
    <>
      <p className="text-xs   text-zinc-100 leading-looser pb-6 lg:mt-2 container mx-auto">
        {`       PRIVACY NOTICE Last updated January 25, 2022 Thank you for choosing to
        be part of our community at aped in llc ("Company," "we," "us," or
        ...
        information, please contact us at joey@sellonsocial.co. This privacy
        notice describes how we might use your information if you: Visit our
        website at https://sellonsocial.co Engage with us in other related ways
        ...
        references or links to this policy "Services," we are referring to our
        Website, and other related services, including any sales, marketing, or
        events The purpose of this privacy notice is to explain to you in the
        ...
        Services immediately. Please read this privacy notice carefully, as it
        will help you understand what we do with the information that we
        collect. TABLE OF CONTENTS 1. WHAT INFORMATION DO WE COLLECT? 2. HOW DO
        WE USE YOUR INFORMATION? 3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?
        4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES? 5. WHAT IS OUR
        STANCE ON THIRD-PARTY WEBSITES? 6. HOW LONG DO WE KEEP YOUR INFORMATION?
        7. HOW DO WE KEEP YOUR INFORMATION SAFE? 8. DO WE COLLECT INFORMATION
        FROM MINORS? 9. WHAT ARE YOUR PRIVACY RIGHTS? 10. CONTROLS FOR
        DO-NOT-TRACK FEATURES 11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY
        RIGHTS? 12. DO WE MAKE UPDATES TO THIS NOTICE? 13. HOW CAN YOU CONTACT
        US ABOUT THIS NOTICE? 14. HOW CAN YOU REVIEW, UPDATE OR DELETE THE DATA
        WE COLLECT FROM YOU? 1. WHAT INFORMATION DO WE COLLECT? Personal
        information you disclose to us In Short: We collect personal information
        ...
        in activities on the Website or otherwise when you contact us. The
        ...
        names; email addresses; job titles; and other similar information.
        ...
        instrument. All payment data is stored by stripe.com. You may find their
        privacy notice link(s) here: https://stripe.com/privacy. All personal
        ...
        targeted advertising and event promotion. 2. HOW DO WE USE YOUR
        INFORMATION? In Short: We process your information for purposes based on
        ...
        the information we collect or receive: To send administrative
        ...
        to determine how to respond. To send you marketing and promotional
        ...
        is in accordance with your marketing preferences. For example, when
        expressing an interest in obtaining information about us or our Website,
        ...
        at any time (see the "WHAT ARE YOUR PRIVACY RIGHTS?" below). Deliver
        targeted advertising to you. We may use your information to develop and
        display personalized content and advertising (and work with third
        parties who do so) tailored to your interests and/or location and to
        measure its effectiveness. 3. WILL YOUR INFORMATION BE SHARED WITH
        ANYONE? In Short: We only share information with your consent, to comply
        ...
        information for a specific purpose. Legitimate Interests: We may process
        your data when it is reasonably necessary to achieve our legitimate
        business interests. Performance of a Contract: Where we have entered
        into a contract with you, we may process your personal information to
        fulfill the terms of our contract. Legal Obligations: We may disclose
        ...
        to meet national security or law enforcement requirements). Vital
        ...
        portion of our business to another company. Business Partners. We may
        share your information with our business partners to offer you certain
        products, services or promotions. 4. DO WE USE COOKIES AND OTHER
        ...
        Cookie Notice. 5. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES? In Short:
        ...
        our Website. The Website may contain advertisements from third parties
        ...
        and privacy of data you provide to any third parties. Any data collected
        ...
        respond to your questions. 6. HOW LONG DO WE KEEP YOUR INFORMATION? In
        ...
        access the Website within a secure environment. 8. DO WE COLLECT
        ...
        children under age 18, please contact us at joey@sellonsocial.co. 9.
        WHAT ARE YOUR PRIVACY RIGHTS? In Short: You may review, change, or
        terminate your account at any time. If you are a resident in the EEA or
        ...
        visit http://www.aboutads.info/choices/. 10. CONTROLS FOR DO-NOT-TRACK
        ...
        practice in a revised version of this privacy notice. 11. DO CALIFORNIA
        ...
        from all our systems (e.g. backups, etc.). CCPA Privacy Notice The
        California Code of Regulations defines a "resident" as: (1) every
        ...
        our business activities NO I. Professional or employment-related
        ...
        Education Information Student records and directory information NO K.
        Inferences drawn from other personal information Inferences drawn from
        any of the collected personal information listed above to create a
        profile or summary about, for example, an individual’s preferences and
        characteristics NO We may also collect other personal information
        outside of these categories instances where you interact with us
        ...
        email at joey@sellonsocial.co, or by referring to the contact details at
        ...
        be "selling" of your personal data. aped in llc has not disclosed or
        sold any personal information to third parties for a business or
        commercial purpose in the preceding 12 months. aped in llc will not sell
        personal information in the future belonging to website visitors, users
        and other consumers. Your rights with respect to your personal data
        Right to request deletion of the data - Request to delete You can ask
        for the deletion of your personal information. If you ask us to delete
        ...
        such as (but not limited to) the exercise by another consumer of his or
        her right to free speech, our compliance requirements resulting from a
        ...
        selling personal information. In accordance with applicable law, we are
        ...
        may also use other verification methods as the circumstances dictate. We
        ...
        the data. you can designate an authorized agent to make a request under
        ...
        from future selling of your personal information to third parties. Upon
        receiving a request to opt-out, we will act upon the request as soon as
        feasibly possible, but no later than 15 days from the date of the
        request submission. To exercise these rights, you can contact us by
        email at joey@sellonsocial.co, or by referring to the contact details at
        the bottom of this document. If you have a complaint about how we handle
        your data, we would like to hear from you. 12. DO WE MAKE UPDATES TO
        ...
        joey@sellonsocial.co or by post to: aped in llc 7097 Redwing Place
        Longmont, CO 80503 United States 14. HOW CAN YOU REVIEW, UPDATE, OR
        DELETE THE DATA WE COLLECT FROM YOU? Based on the applicable laws of
        your country, you may have the right to request access to the personal
